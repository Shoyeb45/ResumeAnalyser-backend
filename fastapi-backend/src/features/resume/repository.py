...
class ResumeRepository:
    ...
    @staticmethod
    async def create_resume(resume_data: Dict[str, Any]) -> Resume:
        """
        ...
        if resume_data.get('is_primary', False):
            await ResumeRepository._ensure_single_primary_resume(resume_data['user_id'])
    ...
    @staticmethod
    async def delete_resume(resume_id: PydanticObjectId) -> bool:
        """
        Delete resume by ID

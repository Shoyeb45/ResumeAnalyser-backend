...
class ResumeDetailsExtractor:
    ...
    def parse_resume_with_json_extraction(self, groq_response):
        """
        ...
        try:
            ...
            # Extract JSON string
            json_string = self.extract_json_from_response(response_text)
            ...
            if json_string:
                ...
                logger.warning("Raw response:", response_text[:200] + "..." if len(response_text) > 200 else response_text)
                return None
    ...
    def get_resume_details(self, text: str):
        try:
            logger.info("Sent the text to groq for getting structure output of the resume")
            ...
            return self.parse_resume_with_json_extraction(extracted_json)
        except Exception as e:
